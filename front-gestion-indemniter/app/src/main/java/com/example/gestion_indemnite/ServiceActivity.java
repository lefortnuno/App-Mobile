                    ...
                    if (jsonArray.length() > 0) {
                        for (int i = 0; i < jsonArray.length(); i++) {
                            JSONObject jsonObject1 = jsonArray.getJSONObject(i);
                             ...
                             String id = jsonObject1.getString("id_service");
                            serviceModel mode= new serviceModel();
                            mode.setId_service(jsonObject1.getInt("id_service"));
                            mode.setLibelle(jsonObject1.getString("libelle"));
                            mode.setSalaire_heure(jsonObject1.getInt("salaire_heure"));
                            mode.setNb_jour(jsonObject1.getInt("nb_jour"));
...
private void search(){
    ...
    arrayList= new ArrayList<>();
       ...
       StringRequest stringRequest = new StringRequest(Request.Method.GET, routes.URL_service+"/"+nom, new Response.Listener<String>() {
