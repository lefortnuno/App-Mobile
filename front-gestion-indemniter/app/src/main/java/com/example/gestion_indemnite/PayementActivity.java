...
public class PayementActivity extends AppCompatActivity {
    ...
    public boolean onContextItemSelected(MenuItem item){
        ...
        switch (id){
                        ...
                        try{
                            ...
                            if(jsonArray.length()>0){
                                for(int i=0; i<jsonArray.length(); i++){
                                    ...
                                    String id_payement=  jsonObject1.getString("id_payement");
                                    String nom=  jsonObject1.getString("nom");
                                    String description=  jsonObject1.getString("description");
                                    String payement=  jsonObject1.getString("payement");
                                    String endamnite=  jsonObject1.getString("endamnite");
            ...
            case R.id.btnSupprimer: {
                ...
                Toast.makeText(PayementActivity.this, " On ne peut pas effacer un paiement", Toast.LENGTH_LONG).show();
                break;
            }
            default:
                break;
                ...
                try {
                    ...
                    if (jsonArray.length() > 0) {
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            mode.setId_payement(jsonObject1.getInt("id_payement"));
                            mode.setNom(jsonObject1.getString("nom"));
                            mode.setDescription(jsonObject1.getString("description"));
                            mode.setPayement(jsonObject1.getInt("payement"));
                            mode.setDate(jsonObject1.getString("date"));
    ...
    private void search(){
        ...
        StringRequest stringRequest= new StringRequest(Request.Method.GET, routes.URL_payement+"/"+nom, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try{
                    JSONObject jsonObject= new JSONObject(response);
