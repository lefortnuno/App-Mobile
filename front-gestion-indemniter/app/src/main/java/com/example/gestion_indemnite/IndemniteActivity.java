...
public class IndemniteActivity extends AppCompatActivity {
    ...
    private  void  getIndemnite() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, routes.URL_indemnite, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (jsonArray.length() > 0) {
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            mode.setId_endamnite(jsonObject1.getInt("id_endamnite"));
                            mode.setNom(jsonObject1.getString("nom"));
                            mode.setService(jsonObject1.getString("service"));
                            mode.setHeure_travail(jsonObject1.getInt("heure_travail"));
                            mode.setSalaire_heure(jsonObject1.getInt("salaire_heure"));
                            mode.setMontant(jsonObject1.getInt("montant"));
